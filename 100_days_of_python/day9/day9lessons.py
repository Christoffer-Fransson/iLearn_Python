...
winner = received_bids["Bidder"][received_bids["Bids"].index(winning_bid)]

# for bid in received_bids["Bids"]:             # Max() works similar to this. this is a solution if a mechanical examination is required
#     if bid > winning_bid:
#         winning_bid = bid
